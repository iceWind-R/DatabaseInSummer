<%@ page import="domain.PersonTicket" %>
...
<div class="wrap" id="wrap">
    <div class="container">
        <h3 style="text-align: center">个人已购门票</h3>
        ...
        <table border="1" class="table table-bordered table-hover" style="background-color: snow">
            ...
            <%
                ...
                ArrayList<PersonTicket> lists = (ArrayList<PersonTicket>) request.getAttribute("lists");
                for (PersonTicket bi : lists) {
                    int id = bi.getId();
            %>
            <tr>
                <td><%=id%></td>
                ...
                <td>
                    <a href="delPersonTicketServlet?id=<%=id%>&date=<%=bi.getDate()%>"  onclick="if(confirm('确认删除吗？')==false)return false;">取消购买</a>
                </td>
            </tr>
            <%
                }
